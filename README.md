...
##### Зміст  
- [Інсталяція продукту](#instalation)  
- [Наявний функціонал](#functionality) 
    - [Робота з файлами у клієнті](#work_with_files)   
    - [Переміщення між файлами та каталогами](#movement)   
    - [Робота у режимі командного рядка](#command)   
    - [Список виконуваних-плагінів](#bins)   
    - [Робота із функціоналом тестування](#testing)   
- [Розробка плагінів](#development)  
    - [Розробка плагіна-драйвера файлу](#driverDev)   
    - [Розробка виконуваного плагіну](#binDev)   
...
```console
zhukowych@zhukowych:~$ tar –xvzf <архів релізу>.tar.gz
```
